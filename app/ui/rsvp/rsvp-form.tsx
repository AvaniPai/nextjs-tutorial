  ...
  return (
    <form action={dispatch}>
      <div className="container rounded-md bg-pink-50 max-width mx-auto p-4 md:p-6">
        {/* Party Size */}
        <div className="mb-4">
          <label htmlFor="amount" className="mb-2 block text-sm font-medium text-lg">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="number"
                placeholder="1"
                className="peer block w-full rounded-md border-none py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              />
