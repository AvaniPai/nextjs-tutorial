...
export function OurStoryBlock1() {
	return (
		<div className="md:grid md:grid-cols-2 w-full justify-self-center md:bg-gray-100  xl:p-10">
			...
			<div className="text-center bg-white md:p-5 p-2">
				...
				<br/>
				<article className="text-pretty">アバニは、そのチームメイトの名前がシンゴであること、そして彼の横に立っている熱心でよく日焼けした友人の名前がシュウスケであることを知った。 シンゴは英語で、シュウスケが大学で留学生に会うのを楽しみにしていて、どうしたら留学生と友達になれるか悩んでいると説明した。 シュウスケは英語があまり分からなかったようで定期的に「イエーイ！」とハイタッチをして、アバニを楽しませた。
