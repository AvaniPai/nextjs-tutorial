...
const links = [
  ...
  },
  {
    ...
    jp_name: '臨時バス',
    en_href: '/wedding/en/transportation',
    jp_href: '/wedding/jp/transportation',
  },
  {
    en_name: 'TRAVEL TIPS', 
    jp_name: 'おすすめの旅行プラン',
      ...
      {links.map((link) => {
        return (
          <Link
            ...
            className={clsx(
              'flex grow items-center justify-center md:gap-2 rounded-md p-1 md:p-3 text-xs md:text-xl font-medium h-[40px] hover:bg-lightbrown hover:text-mediumbrown md:h-[100px] md:flex-none md:p-2 md:px-3',
        )}
          >
